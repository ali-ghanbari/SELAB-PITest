...
public class CheckTestHasFailedResultListener implements TestListener {
  ...
  private Option< ArrayList<Description> > allFailingTests = Option.none();
  ...
  public void onTestFailure(final TestResult tr) {
    ...
    if (! this.allFailingTests.hasSome()) {
       this.allFailingTests = Option.some(new ArrayList<Description>());
    }
    this.allFailingTests.value().add(tr.getDescription());
  }
  ...
  public Option< ArrayList<Description> > getAllFailingTests() {
